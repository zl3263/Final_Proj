...
(4) Use correlation analysis to analyze the correlation degree between different factors affecting  housing price and housing price, and analyze the correlation degree  through the correlation graph. Qualitative and visual analysis of the correlation between different  factors affecting housing price and housing price with bar chart
...
For attributes with too large missing data, you can choose to  discard them, and for attribute data with small missing data, you can  fill them in four ways:
